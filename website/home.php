	...
	<body>
		...
		<div class="content-outer">
			...
			<div class="table-title">
				<h3 class="title"><strong>Current Posts</strong></h3><br><br>
			</div>
<?php
$localhost="localhost";
$username="root";
...
$database="post";
  ...
  $con=mysqli_connect("localhost","root","Connect_root123!","post");
    ...
    while($row = mysqli_fetch_array($result)) {
		...
		echo "<a href='http://192.168.200.55/website/categories/category/"; echo $row['category']; echo ".php'>"; 
echo $row['category']; 
echo "</a>";
		...
		echo "<summary style='float:left; padding:5px;'>RATE NOW </summary>";
			echo "<form action='ratepost.php' method='post'>";
				echo "<label>";
...
echo "<br><br>";
  $connection=mysqli_connect("localhost","root","Connect_root123!","post");
    ...
    if ( $row['comment'] == $info['oldcomment']){ 
       ...
       echo "@ ";
       echo $info['date'];
       echo " from <font style='color:red;'>";
       echo $info['uid'];
       echo "</font>:  ";
       echo $info['comment'];
       echo "<br>";
...
echo "<tr>";
echo "<th class='' colspan='2'>";
echo "<form action='postcomments.php#"; 
echo "' method='post' id='";
echo "'>";
$temp = $row['comment'];
/*echo $row['postid'];*/
...
echo '<input type="hidden" name="postid" value="'.$row['postid'].'"></input>';
echo "<textarea rows='2' cols='63' name='comment'>Enter Comment here....</textarea>";
