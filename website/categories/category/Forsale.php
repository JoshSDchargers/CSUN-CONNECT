	...
	<body>
		...
		<div class="content-outer">
			...
			<div class="table-title">
				<h3 class="title"><strong>For Sale</strong></h3><br><br>
			</div>
<?php
$localhost="localhost";
$username="root";
...
$database="post";
  ...
  $con=mysqli_connect("localhost","root","Connect_root123!","post");
	...
	if ($row['category'] == 'Forsale'){ //change to catarogy	
		...
		echo "<summary style='float:left; padding:5px;'>RATE NOW </summary>";
			echo "<form action='rate/rate10.php' method='post'>";
				echo "<label>";
...
echo "<tr>";
echo "<th class='' colspan='2'>";
echo "<form action='comment/post10.php#"; 
echo "' method='post' id='";
echo "'>";
$temp = $row['comment'];
/*echo $row['postid'];*/
