...
<div class="content-outer">
			...
			<div class="table-title">
				...
				<table class="table-fill">
					<thead>
						<tr>
							<th class="red_th" colspan="2">Login to your account</th>
						</tr>
					</thead>
...
<div class="container">
  <div class="login">
      ...
      <input type="text" name="uid" placeholder="Username" required="required" class="input-txt" autofocus autocomplete="off" />
<input type="password" name="pwd" placeholder="Password" required="required" class="input-txt" autocomplete="off" />
